...
class CircularTimerView : View {
    ...
    private fun initPaints(
        ...
        roundedCorners = ta.getBoolean(R.styleable.CircularTimerView_roundCorners, false)
        ...
        ta.recycle()
        textPaint = TextPaint()
        (textPaint as TextPaint).setColor(progressTextColor)
        val c = String.format("#%06X", 0xFFFFFF and progressTextColor)
        (textPaint as TextPaint).setColor(Color.parseColor(c))
